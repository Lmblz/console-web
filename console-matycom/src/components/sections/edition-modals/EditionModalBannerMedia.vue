<template>
    ...
    <v-dialog width="80%" :retain-focus="false">
        <v-card title="Édition de la bannière de média" class="px-2 pb-2" color="background">
            <v-expansion-panels>
                <v-expansion-panel>
                    <template #title>
                    ...
                    <template #text>
                        ...
                        <v-row class="align-center border-t">
                            ...
                            <v-col cols="8">
                                <v-row>
                                    <v-col cols="9">
                                        <v-text-field v-model="tempSection.picture.desktopPicture.url" density="compact" variant="outlined" hide-details />
                                    </v-col>
                                    <v-col cols="3">
                                        <v-select label="extension" :items="['jpg', 'png', 'gif']" density="compact" variant="outlined" hide-details
                                                  v-model="tempSection.picture.desktopPicture.extension" />
                                    </v-col>
                                </v-row>
                            </v-col>
                        </v-row>
                        <v-row class="align-center border-t">
                            ...
                            <v-col cols="8">
                                <v-row>
                                    <v-col cols="9">
                                        <v-text-field v-model="tempSection.picture.mobilePicture.url" density="compact" variant="outlined" hide-details />
                                    </v-col>
                                    <v-col cols="3">
                                        <v-select label="extension" :items="['jpg', 'png', 'gif']" density="compact" variant="outlined" hide-details
                                                  v-model="tempSection.picture.mobilePicture.extension" />
                                    </v-col>
                                </v-row>
                            </v-col>
                        </v-row>
                        <v-row class="align-center border-t">
                            ...
                            <v-col cols="8">
                                <v-text-field v-model="tempSection.picture.alt" density="compact" variant="outlined" hide-details />
                            </v-col>
                        </v-row>
                    </template>
                </v-expansion-panel>
                <v-expansion-panel v-if="tempSection.content">
                    <template #title>
                        <v-row class="ma-0 align-center">
                            <h4>Paramètre du contenu</h4>
                            <v-row class="ma-0 justify-end ga-2 pr-4 actions-section">
                                <p @click.native.stop="eventSection('delete')" class="text-caption text-decoration-underline">Supprimer</p>
                            </v-row>
                        </v-row>
                    </template>
                    <template #text>
                        <v-row class="align-center border-t">
                            ...
                            <v-col cols="8">
                                <v-text-field v-model="tempSection.content.titleH2.text" density="compact" variant="outlined" hide-details />
                            </v-col>
                        </v-row>
                        <v-row class="align-center border-t">
                            <v-col cols="4">
                            ...
                            <v-col cols="8">
                                <tiny-mce id="editor" :init="tinymceSectionsConfig" v-model="tempSection.content.description.text" />
                            </v-col>
                        </v-row>
                        <v-row class="align-center border-t">
                            <v-col cols="4">
                            ...
                            <v-col cols="8">
                                <v-text-field v-model="tempSection.content.button.text" density="compact" variant="outlined" hide-details />
                            </v-col>
                        </v-row>
                        <v-row class="align-center border-t">
                            <v-col cols="4">
                            ...
                            <v-col cols="8">
                                <v-text-field v-model="tempSection.content.button.url" density="compact" variant="outlined" hide-details />
                            </v-col>
                        </v-row>
                    </template>
                </v-expansion-panel>
            </v-expansion-panels>
            <v-btn v-if="!tempSection.content" variant="plain" color="primary" text="Ajouter un contenu" @click="tempSection.content = new Section().getEmptyElement(tempSection._type)" />
            <v-card-actions>
